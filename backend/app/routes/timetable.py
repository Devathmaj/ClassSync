...
def list_timetables(
    ...
    return timetable_service.get_timetables(str(current_user.id), db)
...
def create_timetable(
    ...
    return timetable_service.create_timetable(str(current_user.id), payload.dict(), db)
...
def get_timetable(
    ...
    try:
        return timetable_service.get_timetable(timetable_id, str(current_user.id), db)
...
def update_timetable(
    ...
    try:
        return timetable_service.update_timetable(timetable_id, str(current_user.id), payload.dict(exclude_unset=True), db)
    except ValueError as e:
        raise HTTPException(status_code=404, detail=str(e))
...
def delete_timetable(
    ...
    try:
        timetable_service.delete_timetable(timetable_id, str(current_user.id), db)
    except ValueError as e:
        raise HTTPException(status_code=404, detail=str(e))
...
def validate_timetable(
    ...
    try:
        return timetable_service.validate_timetable(timetable_id, str(current_user.id), db)
    except ValueError as e:
        raise HTTPException(status_code=404, detail=str(e))
...
def publish_timetable(
    ...
    try:
        return timetable_service.publish_timetable(timetable_id, str(current_user.id), db)
    except ValueError as e:
        raise HTTPException(status_code=404, detail=str(e))
